...
"""
bindgen_kernel_cmd = '''bindgen %s --allowlist-type="(task_struct|tk_read_base|seqcount_raw_spinlock_t|clocksource|seqcount_t|seqcount_latch_t|timekeeper|kcsan_ctx|rnd_state|timespec64|bpf_spin_lock|bpf_sysctl_kern|xdp_buff|ethhdr|iphdr|tcphdr|udphdr)"
