...
To update the Linux submodule link, do the following 2 steps:
1. Backport commit [[69680052549b][https://github.com/rosalab/inner_unikernels/commit/69680052549ba993049c05bcb6e3573b3bc23dc3.patch]]
2. Sync submodule
#+BEGIN_SRC bash
git submodule sync
#+END_SRC
