...
#[inline(always)]
fn iu_recursive(obj: &tracepoint, _: tp_ctx) -> Result {
...
#[entry_link(inner_unikernel/tracepoint/syscalls/sys_enter_write)]
static PROG: tracepoint = tracepoint::new(iu_recursive, "iu_recursive", tp_type::Void);
